...
const schema = [
  ...
  { id: 'minecraftTime', category: 1, type: 'text', min: 2, max: 160 },
  { id: 'dailyHours', category: 1, type: 'number', minValue: 0.5, maxValue: 24 },
  { id: 'activeDays', category: 1, type: 'days' },
  { id: 'futureLimits', category: 1, type: 'text', min: 10, max: 5000 },
  { id: 'discordOutsideHours', category: 1, type: 'text', min: 1, max: 120 },
...
export async function onRequestPost(context) {
  ...
  try {
    await sendModerationApplicationWebhook(env, {
