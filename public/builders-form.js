(async () => {
  ...
  },
  {
    ...
    "icon": "◷",
    "description": "Evaluaremos si tu disponibilidad y forma de trabajar son compatibles con las necesidades del equipo de construcción.",
    ...
    "questions": [
      ...
      },
      {
        ...
        "help": "Algunas construcciones pueden requerir varias semanas de trabajo. Queremos conocer tu disponibilidad real.",
        "type": "textarea",
      ...
      },
      {
        ...
        "help": "Buscamos formar un equipo estable que pueda mantener proyectos de construcción durante periodos prolongados.",
        "type": "textarea",
  ...
  },
  {
    ...
    "short": "Situaciones",
    "icon": "⚖",
    "description": "Queremos conocer cómo actuarías dentro del equipo de construcción de ARKAWOOD.",
    ...
    "questions": [
      {
        ...
        "help": "Buscamos personas interesadas en aportar de forma constante a la identidad visual y a los proyectos de construcción de ARKAWOOD.",
        "type": "textarea",
  ...
  const submitApplication = async () => {
    ...
    try {
      const response = await fetchWithTimeout('/api/applications/builders', {
        method: 'POST',
        credentials: 'same-origin',
        headers: {
