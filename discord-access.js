(() => {
  ...
  const errorMessages = {
    configuration: 'Falta completar la configuración privada de Discord en Cloudflare. El administrador debe añadir DISCORD_CLIENT_SECRET y un SESSION_SECRET seguro antes de activar el acceso.',
